...
function BookForm({venue, accessToken, apiKey}) {
  ...
  return(
    <form onSubmit={handleSubmit(OnSubmit)}>
      ...
      {accessToken ? <input type="submit" id="list-btn" className="btn btn-primary" value="Book" disabled={enableDisable(!invalid)} data-testid={'bookBtn'}/> : <Link to={'/login'} className="btn btn-primary">Book</Link> }
